  ...
  return (
    <section className="common-padding">
      <div className="screen-max-width">
        <div id="chip" className="flex-center w-full" style={{ marginTop: '5rem', marginBottom: '5rem' }}>
        ...
        <div style={{ marginTop: '2.5rem', marginBottom: '3.5rem' }}>
          ...
          <p className="text-gray-400 font-semibold text-center" style={{ marginTop: '0.75rem' }}>Honkai: Star Rail</p>
          </div>
